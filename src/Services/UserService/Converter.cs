...
using static GetAllUsersResponse.Types;
...
public static class Converter
{
    ...
    public static GetAllUsersResult ConvertGetAllUsersResult(GetAllUsersResultModel result)
    {
        return result switch
        {
            GetAllUsersResultModel.Fail => GetAllUsersResult.Fail,
            GetAllUsersResultModel.Success => GetAllUsersResult.Success,
            GetAllUsersResultModel.DbIsEmpty => GetAllUsersResult.DbIsEmpty,
            _ => GetAllUsersResult.Unspecified,
        };
    }
